...
df.to_csv(f"{PROCESSED_DIR}/scraped.csv")
df.head()
...
df = pd.read_csv(f"{PROCESSED_DIR}/scraped.csv", index_col=0)
...
df.to_csv(f"{PROCESSED_DIR}/embeddings.csv")
df.head()
